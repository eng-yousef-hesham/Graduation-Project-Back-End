...
import org.gp.civiceye.config.users.EmployeeUserDetailsService;
...
public class EmployeeUsernamePasswordAuthenticationProvider implements AuthenticationProvider {
    ...
    @Autowired
    public EmployeeUsernamePasswordAuthenticationProvider(EmployeeUserDetailsService userDetailsService, PasswordEncoder passwordEncoder) {
