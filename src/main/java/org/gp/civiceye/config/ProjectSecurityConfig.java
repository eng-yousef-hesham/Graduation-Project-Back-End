    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/V1/cities/").hasAnyRole("MASTERADMIN", "CITIZEN","CITYADMIN")
                        .requestMatchers("/api/V1/departments").hasAnyRole("MASTERADMIN", "CITIZEN","CITYADMIN")
                        .requestMatchers("/api/V1/governorates").hasAnyRole("MASTERADMIN", "CITIZEN","CITYADMIN")
